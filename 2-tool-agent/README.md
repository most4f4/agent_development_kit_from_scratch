...
- Built-in tools can only be used with gemini models that support tool use.
- See the [ADK documentation](https://google.github.io/adk-docs/tools/built-in-tools/#use-built-in-tools-with-other-tools) for more details.
...
- **Docstrings**: The function's docstring serves as the tool's description and is sent to the LLM
  ...
  - **Note**: The docstring is a way to provide context to the LLM about what the tool does so it can decide when and how to use it

### 3. Third-Party Tools

You can also integrate third-party tools into your agents by wrapping their functionality in custom function tools. This allows your agent to leverage external APIs and services seamlessly.
Examples: LangChain, CrewAI, SerpAPI, etc.
