...
# return type is Optional[types.Content] because returning None continues normal processing
# return None when no special handling is needed
# return a types.Content object to short-circuit normal processing
