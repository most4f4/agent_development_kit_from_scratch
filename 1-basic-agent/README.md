...
1. **`__init__.py`**
   ...
   - Tells ADK that in this folder, there is an agent defined in `agent.py` and it should load it
...
3. **`.env` File**
   ...
   - Contains environment variables like API keys
   - Example:
...
- **name** (Required): A unique string identifier for your agent. It should be similar to the folder name for clarity.
